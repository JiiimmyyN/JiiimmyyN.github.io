...
const App = __webpack_require__(27).App;

var json = __webpack_require__(30);
__webpack_require__(31);

ReactDOM.render(React.createElement(App, { data: json }), document.getElementById("root"));
...
const React = __webpack_require__(1);
const Collumn = __webpack_require__(28).Collumn;
...
const React = __webpack_require__(1);
var Element = __webpack_require__(29).Element;
...
class Collumn extends React.Component {
	render() {
		...
		this.props.data["elements"].map((value, index) => {
			elements.push(React.createElement(Element, { key: index, data: value }));
		});
...
class ProjectsElement extends React.Component {
	render() {
		...
		this.props.data["elements"].map((value, index) => {
			projects.push(React.createElement(Element, { key: index, data: value }));
		});
...
class SingleProjectElement extends React.Component {
	render() {
		...
		let e = [];
		this.props.data["elements"].map((value, index) => {
			e.push(React.createElement(Element, { key: index, data: value }));
		});
...
class Element extends React.Component {
	render() {
		...
		if (value.type === "external-download") return React.createElement(
			...
			null,
			value.text
		);else if (value.type === "img") return React.createElement("img", { src: value.URL, width: value.width });else if (value.type === "h1") return React.createElement(
			"h1",
			null,
			value.text
		);else if (value.type === "h2") return React.createElement(
			"h2",
			null,
			value.text
		);else if (value.type === "projects") return React.createElement(ProjectsElement, { data: value });else if (value.type === "project") return React.createElement(SingleProjectElement, { data: value });else return;
	}
}
